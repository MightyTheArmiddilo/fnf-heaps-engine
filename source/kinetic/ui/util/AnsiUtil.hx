package kinetic.ui.util;

// credit to the funkin' crew this is such a True... class
...
class AnsiUtil
{
   ...
   * @return The formatted string.
   */
  public static inline function orange(str:String):String
    return apply(str, AnsiCode.ORANGE);
